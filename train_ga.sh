...
# ML
# train gredient ascent
CUDA_VISIBLE_DEVICES=0 accelerate launch unlearning_ga.py \
...
--checkpoint 'ft_models/ml-1m-base-0.2-ft-5e-5-weight0.2' \
--lr 5e-5 --batch_size 16 --weight 0.2 > ml-1m-base-0.2-ft-5e-5-weight0.2.log
...
--checkpoint ft_models/ml-1m-base-0.2-ft-5e-5-weight0.2/model_3000.pt